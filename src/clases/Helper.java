...
public class Helper {
    ...
    public static void traspuestaIngresada(JTable tabla1, JTable tabla2) {
        int nf, nc, aux;
        nf = tabla1.getRowCount();
        nc = tabla1.getColumnCount();
    ...
    public static void letraP(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                aux = (int) tabla1.getValueAt(i, j);
                if (i == 0 || j == 0 || i == nf / 2 || (j == nc - 1 && i <= (nf - 1) / 2)) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
    ...
    public static void letraY(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if ((i == j && i < (nf - 1) / 2) || (i + j == nc - 1 && i < (nf - 1) / 2) || (j == (nc - 1) / 2 && i >= (nf - 1) / 2)) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
