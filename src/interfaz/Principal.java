...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbOperacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Diaginal Secundaria", "Triangular Superior", "Triangular inferior", "Traspuesta A La Ingresada", "Letra A", "Letra Z", "Letra T", "Letra V", "Letra E", "Letra F", "Letra P", "Letra I", "Letra N", "Letra Y", "Letra X" }));
    ...
    private void cmdCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCrearActionPerformed
        ...
        if (sw == 1) {
            ...
            else if (Integer.parseInt(txtNumFilas.getText()) > 14) {
        ...
        switch (op) {
            case 0:
                if (nf == nc) {
                    ...
                    Helper.mensaje(this, "Operacion NO valida, intentenlo con una matriz nxn", 3);
                }
                break;
            ...
            case 3:
                if (nf != nc) {
                    ...
                    Helper.traspuestaIngresada(tblTablaInicial, tblTablaResultado);
                } else {
                    Helper.traspuestaIngresada(tblTablaInicial, tblTablaResultado);
                }
                break;
            ...
            case 6:
                if (nc % 2 != 0) {
                    ...
                    Helper.mensaje(this, "Operacion NO valida, el Numero de colummnas debe ser impar", 3);
                }
                break;
            ...
            case 7:
                if (nf == nc && nc % 2 != 0) {
                    ...
                    Helper.mensaje(this, "Operacion NO valida, intentelo con una columna nxn y que el numero de columnas sea impar", 3);
                }
                break;
            ...
            case 8:
                if (nf % 2 != 0) {
                    ...
                    Helper.mensaje(this, "Operacion NO valida, el Numero de filas debe ser impar", 3);
                }
                break;
            ...
            case 12:
                if (nf == nc) {
                    ...
                    Helper.mensaje(this, "Operacion NO valida, intentelo con una matriz nxn", 3);
                }
                break;
            ...
            case 13:
                if (nf == nc && nc % 2 != 0) {
                    ...
                    Helper.mensaje(this, "Operacion No valida, intenetelo con una matriz nxn y con un numero de columnas impar", 3);
                }
                break;
